...
const LoginForm = () => {
  ...
  return (
    <form className='form' onSubmit={handleSubmit}>
      ...
      <button onClick={handleClickGoogle} className='buttonGoogle' >
        <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 262" class="logo">
        ...
        <span class="spanGoogle">Continuar con Google</span>
      </button>
