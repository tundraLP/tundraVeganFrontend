...
const Favorite = ({ id, name, price, stock, Type, image, ProductId, deleteFavorite, user }) => {
  return (
    <NavLink to = {user && user.type == "Admin" ? `/Detalle-admin/${ProductId}` : `/Detalle/${ProductId}`} className='link-item'>
